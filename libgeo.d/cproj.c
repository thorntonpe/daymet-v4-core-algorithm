...
DaW,HDF-EOS		Oct, 1997	Changed all "return;" to "return(0);".
					The SGI 64-bit complained about the 
					return statements returning no value.
...
/*#ifndef sun */
tsincos(val, sin_val, cos_val) double val; double *sin_val; double *cos_val;
{ *sin_val = sin(val); *cos_val = cos(val); return(0); }
/* #endif */
