...
typedef struct
{
	...
	size_t ncols;        /* number of columns in the image */
	size_t nrows;        /* number of rows in the image */
...
typedef struct
{
	...
	double* stnx;     /* list of t_air station x coordinates */
	double* stny;     /* list of t_air station y coordinates */
	...
	double elev;      /* elevation of prediction point */
	double slope;     /* slope of the t_air-to-elevation regression */
	long int dam_off; /* offset into day-major data file */
	int nregr;        /* number of regression points */
	int ndays;        /* number of days of simulation */
	int nstns;        /* total number of stations */
